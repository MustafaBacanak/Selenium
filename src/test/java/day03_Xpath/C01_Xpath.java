...
//        boolean gorunum = driver.findElement(By.xpath("//*[@onclick='deleteElement()']")).isDisplayed();
//
//        if (gorunum){
//
//            System.out.println("gorunum test : Passed");
//        }
//        else
//            System.out.println("gorunum test : Failed");
//
//        driver.findElement(By.xpath("//*[@onclick='deleteElement()']")).click();
//
//        boolean addRemove=driver.findElement(By.xpath("//*[@id='content']/h3")).isDisplayed();
//
//        if (addRemove){
